...
sub read_loader {
    my ($name) = @_;
#    $name = find_file ("/home/mroonlee/pintos/src/threads/build/loader.bin") if !defined $name;
	 $name = find_file ("/home/mroonlee/pintos/src/userprog/build/loader.bin") if !defined $name;	#for userprog project
